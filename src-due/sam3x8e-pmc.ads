...
package SAM3x8e.PMC is
   ...
   subtype PMC_SCER_UOTGCLK_Field is SAM3x8e.Bit;
   --  PMC_SCER_PCK array element
   subtype PMC_SCER_PCK_Element is SAM3x8e.Bit;
   ...
   subtype PMC_SCDR_UOTGCLK_Field is SAM3x8e.Bit;
   --  PMC_SCDR_PCK array element
   subtype PMC_SCDR_PCK_Element is SAM3x8e.Bit;
   ...
   subtype PMC_SCSR_UOTGCLK_Field is SAM3x8e.Bit;
   --  PMC_SCSR_PCK array element
   subtype PMC_SCSR_PCK_Element is SAM3x8e.Bit;
   ...
   subtype PMC_PCER0_PID_Element is SAM3x8e.Bit;
   ...
   subtype PMC_PCDR0_PID_Element is SAM3x8e.Bit;
   ...
   subtype PMC_PCSR0_PID_Element is SAM3x8e.Bit;
   ...
   subtype CKGR_UCKR_UPLLEN_Field is SAM3x8e.Bit;
   subtype CKGR_UCKR_UPLLCOUNT_Field is SAM3x8e.UInt4;

   --  UTMI Clock Register
   type CKGR_UCKR_Register is record
      --  unspecified
      Reserved_0_15  : SAM3x8e.UInt16 := 16#800#;
      --  UTMI PLL Enable
      ...
      --  unspecified
      Reserved_24_31 : SAM3x8e.Byte := 16#10#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CKGR_MOR_MOSCXTEN_Field is SAM3x8e.Bit;
   subtype CKGR_MOR_MOSCXTBY_Field is SAM3x8e.Bit;
   subtype CKGR_MOR_MOSCRCEN_Field is SAM3x8e.Bit;
   ...
   subtype CKGR_MOR_MOSCXTST_Field is SAM3x8e.Byte;
   subtype CKGR_MOR_KEY_Field is SAM3x8e.Byte;
   subtype CKGR_MOR_MOSCSEL_Field is SAM3x8e.Bit;
   subtype CKGR_MOR_CFDEN_Field is SAM3x8e.Bit;
   ...
   type CKGR_MOR_Register is record
      ...
      --  unspecified
      Reserved_26_31 : SAM3x8e.UInt6 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CKGR_MCFR_MAINF_Field is SAM3x8e.UInt16;
   subtype CKGR_MCFR_MAINFRDY_Field is SAM3x8e.Bit;
   ...
   subtype CKGR_PLLAR_DIVA_Field is SAM3x8e.Byte;
   subtype CKGR_PLLAR_PLLACOUNT_Field is SAM3x8e.UInt6;
   subtype CKGR_PLLAR_MULA_Field is SAM3x8e.UInt11;
   subtype CKGR_PLLAR_ONE_Field is SAM3x8e.Bit;
   ...
   type CKGR_PLLAR_Register is record
      ...
      --  unspecified
      Reserved_14_15 : SAM3x8e.UInt2 := 16#0#;
      --  PLLA Multiplier
      MULA           : CKGR_PLLAR_MULA_Field := 16#0#;
      --  unspecified
      Reserved_27_28 : SAM3x8e.UInt2 := 16#0#;
      --  Must Be Set to 1
   ...
   subtype PMC_MCKR_PLLADIV2_Field is SAM3x8e.Bit;
   subtype PMC_MCKR_UPLLDIV2_Field is SAM3x8e.Bit;

   --  Master Clock Register
   type PMC_MCKR_Register is record
      --  Master Clock Source Selection
      CSS            : PMC_MCKR_CSS_Field := SAM3x8e.PMC.Main_Clk;
      --  unspecified
      Reserved_2_3   : SAM3x8e.UInt2 := 16#0#;
      --  Processor Clock Prescaler
      PRES           : PMC_MCKR_PRES_Field := SAM3x8e.PMC.Clk_1;
      --  unspecified
      Reserved_7_11  : SAM3x8e.UInt5 := 16#0#;
      --  PLLA Divisor by 2
      PLLADIV2       : PMC_MCKR_PLLADIV2_Field := 16#0#;
      UPLLDIV2       : PMC_MCKR_UPLLDIV2_Field := 16#0#;
      --  unspecified
      Reserved_14_31 : SAM3x8e.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PMC_USB_USBS_Field is SAM3x8e.Bit;
   subtype PMC_USB_USBDIV_Field is SAM3x8e.UInt4;
   ...
   type PMC_USB_Register is record
      ...
      --  unspecified
      Reserved_12_31 : SAM3x8e.UInt20 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type PMC_PCK_Register is record
      --  Master Clock Source Selection
      CSS           : PMC_PCK_CSS_Field := SAM3x8e.PMC.Slow_Clk;
      --  unspecified
      Reserved_3_3  : SAM3x8e.Bit := 16#0#;
      --  Programmable Clock Prescaler
      PRES          : PMC_PCK_PRES_Field := SAM3x8e.PMC.Clk_1;
      --  unspecified
      Reserved_7_31 : SAM3x8e.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PMC_IER_MOSCXTS_Field is SAM3x8e.Bit;
   subtype PMC_IER_LOCKA_Field is SAM3x8e.Bit;
   subtype PMC_IER_MCKRDY_Field is SAM3x8e.Bit;
   subtype PMC_IER_LOCKU_Field is SAM3x8e.Bit;
   --  PMC_IER_PCKRDY array element
   subtype PMC_IER_PCKRDY_Element is SAM3x8e.Bit;
   ...
   subtype PMC_IER_MOSCSELS_Field is SAM3x8e.Bit;
   subtype PMC_IER_MOSCRCS_Field is SAM3x8e.Bit;
   subtype PMC_IER_CFDEV_Field is SAM3x8e.Bit;
   ...
   type PMC_IER_Register is record
      ...
      --  unspecified
      Reserved_4_5   : SAM3x8e.UInt2 := 16#0#;
      ...
      PCKRDY         : PMC_IER_PCKRDY_Field :=
                        (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_11_15 : SAM3x8e.UInt5 := 16#0#;
   ...
   subtype PMC_IDR_MOSCXTS_Field is SAM3x8e.Bit;
   subtype PMC_IDR_LOCKA_Field is SAM3x8e.Bit;
   subtype PMC_IDR_MCKRDY_Field is SAM3x8e.Bit;
   subtype PMC_IDR_LOCKU_Field is SAM3x8e.Bit;
   --  PMC_IDR_PCKRDY array element
   subtype PMC_IDR_PCKRDY_Element is SAM3x8e.Bit;
   ...
   subtype PMC_IDR_MOSCSELS_Field is SAM3x8e.Bit;
   subtype PMC_IDR_MOSCRCS_Field is SAM3x8e.Bit;
   subtype PMC_IDR_CFDEV_Field is SAM3x8e.Bit;
   ...
   subtype PMC_SR_MOSCXTS_Field is SAM3x8e.Bit;
   subtype PMC_SR_LOCKA_Field is SAM3x8e.Bit;
   subtype PMC_SR_MCKRDY_Field is SAM3x8e.Bit;
   subtype PMC_SR_LOCKU_Field is SAM3x8e.Bit;
   subtype PMC_SR_OSCSELS_Field is SAM3x8e.Bit;
   --  PMC_SR_PCKRDY array element
   subtype PMC_SR_PCKRDY_Element is SAM3x8e.Bit;
   ...
   subtype PMC_SR_MOSCSELS_Field is SAM3x8e.Bit;
   subtype PMC_SR_MOSCRCS_Field is SAM3x8e.Bit;
   subtype PMC_SR_CFDEV_Field is SAM3x8e.Bit;
   subtype PMC_SR_CFDS_Field is SAM3x8e.Bit;
   subtype PMC_SR_FOS_Field is SAM3x8e.Bit;
   ...
   subtype PMC_IMR_MOSCXTS_Field is SAM3x8e.Bit;
   subtype PMC_IMR_LOCKA_Field is SAM3x8e.Bit;
   subtype PMC_IMR_MCKRDY_Field is SAM3x8e.Bit;
   subtype PMC_IMR_LOCKU_Field is SAM3x8e.Bit;
   --  PMC_IMR_PCKRDY array element
   subtype PMC_IMR_PCKRDY_Element is SAM3x8e.Bit;
   ...
   subtype PMC_IMR_MOSCSELS_Field is SAM3x8e.Bit;
   subtype PMC_IMR_MOSCRCS_Field is SAM3x8e.Bit;
   subtype PMC_IMR_CFDEV_Field is SAM3x8e.Bit;
   ...
   subtype PMC_FSMR_FSTT_Element is SAM3x8e.Bit;
   ...
   subtype PMC_FSMR_RTTAL_Field is SAM3x8e.Bit;
   subtype PMC_FSMR_RTCAL_Field is SAM3x8e.Bit;
   subtype PMC_FSMR_USBAL_Field is SAM3x8e.Bit;
   subtype PMC_FSMR_LPM_Field is SAM3x8e.Bit;
   ...
   type PMC_FSMR_Register is record
      ...
      --  unspecified
      Reserved_19_19 : SAM3x8e.Bit := 16#0#;
      --  Low Power Mode
   ...
   subtype PMC_FSPR_FSTP_Element is SAM3x8e.Bit;
   ...
   subtype PMC_FOCR_FOCLR_Field is SAM3x8e.Bit;
   ...
   subtype PMC_WPMR_WPEN_Field is SAM3x8e.Bit;
   subtype PMC_WPMR_WPKEY_Field is SAM3x8e.UInt24;
   ...
   subtype PMC_WPSR_WPVS_Field is SAM3x8e.Bit;
   subtype PMC_WPSR_WPVSRC_Field is SAM3x8e.UInt16;
   ...
   subtype PMC_PCER1_PID_Element is SAM3x8e.Bit;
   ...
   type PMC_PCER1_Register is record
      ...
      PID            : PMC_PCER1_PID_Field :=
                        (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_13_31 : SAM3x8e.UInt19 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PMC_PCDR1_PID_Element is SAM3x8e.Bit;
   ...
   subtype PMC_PCSR1_PID_Element is SAM3x8e.Bit;
   ...
   subtype PMC_PCR_PID_Field is SAM3x8e.UInt6;
   subtype PMC_PCR_CMD_Field is SAM3x8e.Bit;
   ...
   subtype PMC_PCR_EN_Field is SAM3x8e.Bit;
   ...
   type PMC_PCR_Register is record
      ...
      --  unspecified
      Reserved_6_11  : SAM3x8e.UInt6 := 16#0#;
      --  Command
      ...
      DIV            : PMC_PCR_DIV_Field :=
                        SAM3x8e.PMC.Periph_Div_Mck;
      --  unspecified
      Reserved_18_27 : SAM3x8e.UInt10 := 16#0#;
      --  Enable
