...
This is a driver for the STMicrosystems L3GD20H three-axis digital output gyroscope \cite{L3GD20}.  A number of constants are defined, but most of them are intended only for internal use.  The constant \constant{addr} is the I2C address of the L3GD20H sensor and is intended for use in the \function{configure} call.
...
\begin{center}
  \begin{tabular}{l|l}
    ...
    \hline
    \constant{fs\_245dps} & Full scale is 245\degree{}/S \\
...
\begin{itemize}
  \item $self$ - The L3GD20H device to read.
  \item $error$ - The error code from any I2C transactions.
  \item Returns an \datatype{rotations} representing the rotation around all axis.
\end{itemize}
...
\begin{itemize}
  \item $self$ - The L3GD20H device to read.
  \item $error$ - The error code from any I2C transactions.
  \item Returns an \datatype{rotations\_dps} representing the rotation around all axis.
\end{itemize}
